...
Usage:
  ...
  python scripts/validate_config.py --agents
  python scripts/validate_config.py --workflow
"""
...
AGENTS_YML = Path("config/agents.yml")
WORKFLOW_YML = Path("config/workflow.yml")
AGENT_SCHEMA = Path("config/schemas/agent.schema.json")
WORKFLOW_SCHEMA = Path("config/schemas/workflow.schema.json")
...
def main() -> int:
    ...
    parser.add_argument("--agents", action="store_true", help="Validate config/agents.yml")
    parser.add_argument("--workflow", action="store_true", help="Validate config/workflow.yml")
