...
Usage:
  ...
  python scripts/preflight.py --workflow config/workflow.yml --stages stages
"""
...
DEFAULT_STAGES = Path("stages")
VALIDATE_CONFIG = Path("scripts/validate_config.py")
VALIDATE_HANDOFF = Path("scripts/validate_handoff.py")
