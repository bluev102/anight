...
These fixtures are intentionally invalid and are meant to exercise failure paths in `adapters/python/scripts/validate_handoff.py`.
...
```bash
python3 adapters/python/scripts/validate_handoff.py --file adapters/python/tests/fixtures/invalid_handoffs/<fixture>.json --strict
```
